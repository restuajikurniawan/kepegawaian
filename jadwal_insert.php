...
<?php  require_once "core/init.php"; 
  global $link;
  $query1 = "SELECT `gen_id` ('ID_JADWAL') AS `gen_id`";
...
// die($jam_mulai.' '.$jam_selesai);
    if(insert_jadwal($id_jadwal,$jam_datang,$jam_istirahat,$jam_masuk,$jam_pulang,$jam_terlambat)){
...
?>
            <input type="text" name="id_jadwal" class="form-control" value="<?php echo$row['gen_id']; ?>" readonly>
<?php } ?>
          </td>
         </tr>
          <tr>
           <td width="200"> Jam Datang  </td>
           <td width="500"><input type="time" name="jam_datang" class="form-control"></td>
         </tr>
          <tr>
           <td width="200"> Jam Istirahat  </td>
           <td width="500"><input type="time" name="jam_istirahat" class="form-control"></td>
         </tr>
         <tr>
           <td width="200"> Jam Masuk  </td>
           <td width="500"><input type="time" name="jam_masuk" class="form-control"></td>
         </tr>
         <tr>
           <td width="200"> Jam Pulang </td>
           <td width="500"><input type="time" name="jam_pulang" class="form-control"></td>
         </tr>
         <tr>
           <td width="200"> Batas Terlambat </td>
           <td width="500"><input type="time" name="jam_terlambat" class="form-control"></td>
         </tr>
          <tr>
           <td width="200"></td>
           <td width="500"> 
