...
<?php  require_once "core/init.php"; 
  ...
  if(isset($_POST['submit'])){
    ...
    if(update_status_pegawai($id_pegawai,$id_status)){
      update_status_jjk($id_pegawai,$status);
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Update status pegawai</li>
      </ol>
     <div class="card mb3">
     ...
     <div class="card-body">
      <form action="jenjang_karir_update_stts.php" method="post">
       <table>
<?php 
...
?>
         ...
         <tr>
           ...
           <td width="500"><input type="text" name="stts_lama" class="form-control" value="<?php echo$row['nama_status']; ?>" readonly>
            <input type="hidden" name="id_status" value="<?php echo $row['id_status']; ?>">
            <input type="hidden" name="nm_status">
            <input type="hidden" name="id_pegawai" value="<?php echo $row['id_karyawan']; ?>">
           </td>
         </tr>
<?php } ?>
          <tr>
           <td width="200"> Ubah Status Pegawai </td>
