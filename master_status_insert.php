...
<?php  require_once "core/init.php"; 
  ...
  if(isset($_POST['submit'])){
    ...
    if(insert_master_status($id_status,$nm_status)){
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="card-body">
      <form action="master_status_insert.php" method="post">
       <table>
         <tr>
           <td width="200">Id Status</td>
           <td width="500">
<?php 
foreach (get_id_stts() as $row ){ ?>
            <input type="text" name="id_status" class="form-control" value="<?php echo$row['gen_id']; ?>" readonly>
          </td>
         </tr>
<?php } ?>
          <tr>
           <td width="200"> Status Pegawai </td>
           <td width="500"><input type="text" name="nm_status" class="form-control"></td>
         </tr>
          <tr>
           <td width="200"></td>
           <td width="500"> 
