...
<?php  require_once "core/init.php"; 
  global $link;
  $query1 = "SELECT `gen_id` ('id_bulan') AS `gen_id`";
  ...
  if(isset($_POST['submit'])){
    ...
    if(insert_master_hariraya($id_bulan,$bulan,$tahun)){
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="master_hariraya.php">Master HariRaya</a>
        </li>
        <li class="breadcrumb-item active">Form Insert HariRaya</li>
      </ol>
     <div class="card mb3">
     ...
     <div class="card-body">
      <form action="master_hariraya_insert.php" method="post">
       <table>
         <tr>
...
?>
            <input type="text" name="id_bulan" class="form-control" value="<?php echo$row['gen_id']; ?>" readonly>
<?php } ?>
          </td>
         </tr>
          <tr>
          ...
          <tr>
           ...
           <td width="500"><input type="text" name="tahun" class="form-control"></td>
         </tr>
          <tr>
           <td width="200"></td>
           <td width="500"> 
