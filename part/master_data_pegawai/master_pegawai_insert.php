...
<?php  
  if(isset($_POST['submit'])){
    ...
    if(insert_master_pegawai($id_pegawai,$nip,$nm_pegawai,$jk,$tmp_lahir,$tgl_lahir,$agama,$alamat,$no_tlp,$stts_pernikahan,$jml_anak,$tgl_masuk,$no_npwp,$pend_pegawai,$divisi,$jabatan,$id_status,$a_koperasi)){
...
<?php } ?>
   ...
   <?php require_once $_SERVER['DOCUMENT_ROOT']."/kepegawaian/view/footer.php"; ?>
    ...
    <script src="<?php echo $siteurl; ?>/assets/vendor/jquery-easing/jquery.easing.min.js"></script>
    <!-- Page level plugin JavaScript-->
    <script src="<?php echo $siteurl; ?>/assets/vendor/chart.js/Chart.min.js"></script>
    <script src="<?php echo $siteurl; ?>/assets/vendor/datatables/jquery.dataTables.js"></script>
    <script src="<?php echo $siteurl; ?>/assets/vendor/datatables/dataTables.bootstrap4.js"></script>
    <!-- Custom scripts for all pages-->
    <script src="<?php echo $siteurl; ?>/assets/js/sb-admin.min.js"></script>
    <!-- Custom scripts for this page-->
    <script src="<?php echo $siteurl; ?>/assets/js/sb-admin-datatables.min.js"></script>
    <script src="<?php echo $siteurl; ?>/assets/js/sb-admin-charts.min.js"></script>
    <script src="<?php echo $siteurl; ?>/assets/js/number-format.js"></script>
