...
<?php  require_once "core/init.php"; 
  ...
  if(isset($_POST['submit'])){
    ...
    if(update_div_pegawai($id_pegawai,$id_status)){
      update_div_jjk($id_pegawai,$status);
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Update divisi pegawai</li>
      </ol>
     <div class="card mb3">
        <div class="card-header">
          Update divisi Pegawai
     </div>
     <div class="card-body">
      <form action="jenjang_karir_update_div.php" method="post">
       <table>
<?php 
...
?>
         ...
         <tr>
           <td width="200"> divisi Pegawai </td>
           <td width="500"><input type="text" name="stts_lama" class="form-control" value="<?php echo$row['nama_bagian']; ?>" readonly>
