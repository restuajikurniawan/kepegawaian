...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav" style="background-color: green;">
  <a class="navbar-brand" href="<?php echo $siteurl; ?>/index.php"><img src="<?php echo $siteurl; ?>/image/arrosyid.ico" alt="logo" height="35" width="35"> AR ROSYID </a>
...
<?php if($_SESSION['level'] == 'PERSONALIA' or $_SESSION['level'] == 'HRD' or $_SESSION['level'] == 'KEUANGAN'){?>
            <li>
              <a href="<?php echo $siteurl; ?>/master_pegawai.php"><i class="fa fa-fw fa-credit-card"></i>Master Data Pegawai</a>
            </li>
<?php } ?>
<?php if($_SESSION['level'] == 'HRD'){?>
            <li>
              <a href="<?php echo $siteurl; ?>/master_status.php"><i class="fa fa-fw fa-credit-card"></i>Master Status Pegawai</a>
            </li>
            <li>
              <a href="<?php echo $siteurl; ?>/master_divisi.php"><i class="fa fa-fw fa-credit-card"></i>Master Divisi Pegawai</a>
            </li>
            <li>
              <a href="<?php echo $siteurl; ?>/master_jabatan.php"> <i class="fa fa-fw fa-credit-card"></i> Master Jabatan Pegawai</a>
            </li>
            <li>
              <a href="<?php echo $siteurl; ?>/master_pendidikan.php"> <i class="fa fa-fw fa-credit-card"></i> Master Pendidikan</a>
            </li>
<?php } ?>
          </ul>
        </li>
...
<?php if($_SESSION['level']=='PERSONALIA' or $_SESSION['level'] == 'KEUANGAN'){?>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="piutang_pegawai.php">
            <i class="fa fa-fw fa-dashboard"></i>
            <span class="nav-link-text">Utang Pegawai</span>
          </a>
        </li>
<?php } ?>
<?php if($_SESSION['level']=='PERSONALIA' or $_SESSION['level']=='HRD'){?>
...
<?php if($_SESSION['level']=='HRD'){?>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="jenjang_karir.php">
            <i class="fa fa-fw fa-dashboard"></i>
            <span class="nav-link-text">Jenjang Karir</span>
          </a>
        </li>
<?php } ?>
<?php if($_SESSION['level']=='HRD'){?>
