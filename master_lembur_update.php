...
<?php  require_once "core/init.php"; 
  ...
  if(isset($_POST['submit'])){
    ...
    if(update_master_lembur($id_lembur,$nm_lembur,$jumlah_lembur,$status)){
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Form Update Lembur</li>
      </ol>
     <div class="card mb3">
     ...
     <div class="card-body">
      <form action="master_lembur_update.php" method="post">
       <table>
         <tr>
           <td width="200"> Id Lembur </td>
           <td width="500">
<?php 
foreach (data_lembur_byid($id) as $row) {
?>
            <input type="text" name="id_lembur" class="form-control" value="<?php echo $row['id_master_lembur']; ?>" readonly>
          </td>
         </tr>
          <tr>
           <td width="200"> Nama Lembur </td>
           <td width="500"><input type="text" name="nm_lembur" class="form-control" value="<?php echo $row['nama_lembur']; ?>"></td>
         </tr>
          <tr>
           <td width="200"> Jumlah  </td>
           <td width="500"><input type="text" name="jumlah_lembur" class="form-control" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" value="<?php echo $row['gaji_lembur']; ?>"></td>
         </tr>
<?php } ?>
          <tr>
