...
<?php  require_once "core/init.php"; 
  ...
  if(isset($_POST['submit'])){
    ...
    if(update_jbtn_pegawai($id_pegawai,$id_status)){
      update_jbtn_jjk($id_pegawai,$status);
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Update Jabatan pegawai</li>
      </ol>
     <div class="card mb3">
        <div class="card-header">
          Update Jabatan Pegawai
     </div>
     <div class="card-body">
      <form action="jenjang_karir_update_jbtn.php" method="post">
       <table>
<?php 
...
?>
         ...
         <tr>
           <td width="200"> Jabatan Pegawai </td>
           <td width="500"><input type="text" name="stts_lama" class="form-control" value="<?php echo$row['nama_jabatan']; ?>" readonly>
            <input type="text" name="id_status" value="<?php echo $row['id_bagian']; ?>">
